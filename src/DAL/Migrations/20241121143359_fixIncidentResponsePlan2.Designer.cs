...
namespace DAL.Migrations
{
    ...
    [Migration("20241121143359_fixIncidentResponsePlan2")]
    partial class fixIncidentResponsePlan2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.IncidentResponsePlanTask", b =>
                {
                    ...
                    b.HasIndex("CreatedByValue");

                    b.HasIndex("LastTestedById");

                    b.HasIndex("PlanId");

                    b.HasIndex("UpdatedByValue");
            ...
            modelBuilder.Entity("IncidentResponsePlanTaskToUser", b =>
                {
                    b.Property<int>("IncidentResponsePlanTaskId")
                        .HasColumnType("int(11)");
                    ...
                    b.HasKey("IncidentResponsePlanTaskId", "EntityId")
                        .HasName("PRIMARY")
                        .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

                    b.HasIndex(new[] { "EntityId", "IncidentResponsePlanTaskId" }, "irt_id");

                    b.ToTable("IncidentResponsePlanTaskToEntity", (string)null);
            ...
            modelBuilder.Entity("IncidentResponsePlanTaskToUser", b =>
                {
                    ...
                    b.HasOne("DAL.Entities.IncidentResponsePlanTask", null)
                        .WithMany()
                        .HasForeignKey("IncidentResponsePlanTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
