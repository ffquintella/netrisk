...
namespace DAL.Migrations
{
    ...
    [Migration("20260611141630_SchemaUpgradeLog")]
    partial class SchemaUpgradeLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DAL.Entities.IncidentResponsePlanTask", b =>
                {
                    ...
                    b.HasIndex(new[] { "IsOptional" }, "idx_irpt_optinal");

                    b.HasIndex(new[] { "IsParallel" }, "idx_irpt_parallel");

                    b.HasIndex(new[] { "Priority" }, "idx_irpt_priority");

                    b.HasIndex(new[] { "IsSequential" }, "idx_irpt_sequencial");
