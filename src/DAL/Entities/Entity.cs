...
public partial class Entity
{
    ...
    public virtual ICollection<Incident> IncidentsReported { get; set; } = new List<Incident>();
    
    public virtual ICollection<Incident> IncidentsImpacted { get; set; } = new List<Incident>();
}
